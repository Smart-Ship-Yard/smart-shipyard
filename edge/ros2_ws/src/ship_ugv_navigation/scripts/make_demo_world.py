...
-------------------------------------
JG방 맵(shipyard_map_v1_JG_room)은 12.07 m^2 중 3.99 m^2만 탐사됐고, 그 자유공간이
대각선 띠 모양이라 배 주위로 원을 그릴 공간이 없다. 실측 검증 결과 완주 가능한
반지름이 0.35m 하나뿐이고 안전여유가 0이었다 (2026-08-05 분석).
=> 그 맵은 "장애물 회피 동작 확인용"으로만 쓰고, 순찰 파라미터 튜닝은
